...
class EmailRedefinicaoSenha extends Email {
  constructor (usuario, token) {
    ...
    this.text = `Olá! Você pediu para redefinir sua senha. Use o token a seguir para trocar a senha: ${token}`
    this.html = `<h1>Olá!</h1> Você pediu para redefinir sua senha: ${token}`
  }
}
